...
UBISOFT_AUTH_PATH = DATA_DIR / "ubisoft_auth.json"
XBOX_AUTH_PATH = DATA_DIR / "xbox_auth.json"
NOTIFICATIONS_STATE_PATH = DATA_DIR / "notifications_state.json"
CLAIMED_DROPS_PATH = DATA_DIR / "claimed_drops.json"
